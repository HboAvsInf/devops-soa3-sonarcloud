...
describe("Release Sprint test", () => {
	...
	describe("Release Sprint", () => {
		...
		it("ReleaseSprint state to FinishState", () => {
			...
			// Assert
			expect(() => releaseSprint.state.created()).toThrow(Error("Method not implemented."));
		});
		...
		it("ReleaseSprint state to FinishState", () => {
			...
			// Assert
			expect(() => releaseSprint.state.inProgress).toThrow(Error("Method not implemented."));
		});
		...
		it("ReleaseSprint state to FinishState", () => {
			...
			// Assert
			expect(() => releaseSprint.state.cancelled).toThrow(Error("Method not implemented."));
		});
